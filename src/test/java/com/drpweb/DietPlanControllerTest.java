...
public class DietPlanControllerTest {
    ...
    public void getBmi() throws Exception {
        ...
        when(userService.findByUserName("bbbbbb")).thenReturn(u);
*/
        DailyDiet dd = mock(DailyDiet.class);
//        assertEquals(dd.calBMI(48.0,163.0),18.07);

        assertThat(dd.calBMI(48.0,163.0),is(18.07));
    }
}